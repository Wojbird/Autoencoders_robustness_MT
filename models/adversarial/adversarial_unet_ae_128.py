...
class AdversarialUNetAE128(nn.Module):
    ...
    def __init__(self, config: dict):
        ...
        assert latent_dim == 1568, "Model designed for latent_dim=1568"
        ...
        # Bottleneck
        self.bottleneck = UNetBlock(112, 128, use_dropout=True)  # 128×7×7
        flat_dim = 128 * 7 * 7
        self.fc_enc = nn.Linear(flat_dim, latent_dim)
        self.fc_dec = nn.Linear(latent_dim, flat_dim)

        # Decoder
        self.up1 = nn.ConvTranspose2d(128, 112 , kernel_size=2, stride=2)
